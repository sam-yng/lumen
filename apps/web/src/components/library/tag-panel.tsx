        ...
        {tags.map((tag) => (
          ...
          >
            <button
              ...
              className={`grid h-8 w-full min-w-0 justify-between grid-cols-[auto_minmax(0,1fr)_2rem] items-center gap-2 rounded-md px-2 text-left text-[13px] transition hover:bg-[var(--surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-soft)] ${
